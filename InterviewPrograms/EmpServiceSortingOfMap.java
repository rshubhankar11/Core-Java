 ...
 * 
 * 
 * We also can sort the map using comparable .
 * in that case we need to implements Comparable<Employee> in our entiy calss
 * and need to override compareTo() and need to provide our own logic of
 * comparison
 * 
